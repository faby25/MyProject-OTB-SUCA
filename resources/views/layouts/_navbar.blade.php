<nav x-data="{ open: false }" class="main-header navbar navbar-expand-md navbar-light navbar-white shadow-sm border-b border-gray-100">
    <div class="container">
                      ...
                      <x-slot name="trigger" class="nav-link">
                          ...
                          <div class=" flex text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                              <div class="nav-link">
                                ...
                                <svg class="mt-3 fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
